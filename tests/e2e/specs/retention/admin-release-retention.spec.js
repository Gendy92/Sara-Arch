...
test.describe('retention', () => {
  ...
  test('admin can release retention', async ({ page, api }) => {
    ...
    await projectsPage.releaseRetention(10000);

    await expect(page.locator('text=تم إرجاع ضمان الأعمال')).toBeVisible();
  });
});

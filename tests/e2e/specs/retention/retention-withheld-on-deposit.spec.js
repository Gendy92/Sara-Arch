...
test.describe('retention', () => {
  ...
  test('retention is withheld automatically on deposit', async ({ page, api }) => {
    ...
    await expect(page.locator('.kpi-card', { hasText: 'ضمان محجوز' }).locator('.kpi-value')).toContainText('10,000');
  });
});

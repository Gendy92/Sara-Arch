...
test.describe('projects', () => {
  ...
  test('records a project deposit', async ({ page, api }) => {
    ...
    await projectsPage.addProject(`${prefix}-عميل`, [
      { name: `${prefix}-مشروع`, value: '300000', status: 'active' }
    ]);
    ...
    await projectsPage.addDeposit([
      {
        ...
        payment_method: 'cash',
        date: today,
        description: 'عربون أول'
      }
    ]);

    await expect(page.locator('text=تم حفظ 1 عربون')).toBeVisible();
  });
});

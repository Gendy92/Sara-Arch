...
const App = {
  ...
  pageContent(screen) {
    if (screen === 'dashboard') return `<div class="page-header"><h1>📊 لوحة التحكم</h1></div><div class="kpi-grid" id="kpis"><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div></div><div class="content-grid"><div class="card"><h3>📊 الإيرادات والمصروفات الشهرية</h3><div id="monthly-chart"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div><div class="card"><h3>📉 توزيع المصروفات</h3><div id="expense-chart"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div></div><div class="card"><h3>💳 أرصدة العملاء النشطين</h3><div id="customer-balances"><div class="skeleton skeleton-title"></div><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div><div class="content-grid"><div class="card"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;flex-wrap:wrap;gap:8px"><h3>💰 مستحقات من العملاء</h3><div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center"><div class="kpi-label" style="font-size:13px">الإجمالي: <strong id="aging-clients-total" style="color:var(--red)">--</strong></div><button class="btn btn-sm btn-primary" onclick="App.exportAgingClientsExcel()">📥 Excel</button></div></div><div id="aging-clients-tbl"><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div></div></div><div class="card"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;flex-wrap:wrap;gap:8px"><h3>🏪 مستحقات للموردين</h3><div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center"><div class="kpi-label" style="font-size:13px">الإجمالي: <strong id="aging-vendors-total" style="color:var(--red)">--</strong></div><button class="btn btn-sm btn-primary" onclick="App.exportAgingVendorsExcel()">📥 Excel</button></div></div><div id="aging-vendors-tbl"><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div></div></div></div><div class="content-grid"><div class="card"><h3>🏪 الموردين النشطين</h3><div id="active-vendors"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div><div class="card"><h3>آخر المعاملات</h3><div id="recent-tx"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div></div><div class="card"><h3>المشاريع النشطة</h3><div id="active-proj"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div>`;

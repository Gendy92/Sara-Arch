...
const App = {
  ...
  pageContent(screen) {
    if (screen === 'dashboard') return `<div class="page-header"><h1>📊 لوحة التحكم</h1></div><div class="kpi-grid" id="kpis"><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div></div><div class="content-grid" style="margin-top:16px"><div class="card"><h3>🏢 المكتب: إيرادات vs مصروفات</h3><div id="office-income-expense-total-chart"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div></div><div class="content-grid" style="margin-top:16px"><div class="card"><h3>📈 المشاريع شهريًا</h3><div id="dash-project-monthly-chart"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div><div class="card"><h3>🏢 المكتب شهريًا</h3><div id="dash-office-monthly-chart"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div></div><div class="content-grid" style="margin-top:16px"><div class="card"><h3>🏢 توزيع مصروفات المكتب</h3><div id="dash-office-sectors"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div></div><div class="content-grid" style="margin-top:16px"><div class="card"><h3>🏆 أرصدة الموردين المستحقة</h3><div id="dash-vendors"><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div></div></div><div class="card"><h3>👥 أرصدة العملاء النشطين</h3><div id="dash-clients"><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div></div></div></div><div class="content-grid" style="margin-top:16px"><div class="card"><h3>💼 عهد نقدية غير مقفلة</h3><div id="dash-custody-alerts"><div class="skeleton skeleton-table-row"></div></div></div></div>`;
    ...
    if (screen === 'transactions') return `<div class="page-header"><h1>💰 معاملات المشاريع</h1><div style="display:flex;gap:8px;flex-wrap:wrap"><button class="btn btn-primary" onclick="Crud.addProjectDeposit()">💰 عربون مشروع</button><button class="btn btn-primary" onclick="Crud.addProjectExpense()">🔨 مصروف مشروع</button><button class="btn btn-primary" onclick="Crud.addOfficeCustodyExpense()">🔨 مصروف عهدة</button></div></div><div class="kpi-grid" id="tx-kpis"><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div></div><div class="card"><div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:12px"><button class="btn btn-sm ${App.txTypeFilter==='all'?'btn-primary':'btn-secondary'}" onclick="App.setTxTypeFilter('all')">🏠 الكل</button><button class="btn btn-sm ${App.txTypeFilter==='deposit'?'btn-primary':'btn-secondary'}" onclick="App.setTxTypeFilter('deposit')">💰 الإيداعات</button><button class="btn btn-sm ${App.txTypeFilter==='expense'?'btn-primary':'btn-secondary'}" onclick="App.setTxTypeFilter('expense')">🔨 المصروفات</button></div><div id="tx-tbl"><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div></div></div>`;
    if (screen === 'office') return `<div class="page-header"><h1>🏢 حساب المكتب</h1><div style="display:flex;gap:8px;flex-wrap:wrap"><button class="btn btn-primary" onclick="Crud.addOfficeExpense()">🏢 مصروف مكتبي</button><button class="btn btn-primary" onclick="Crud.addOfficeCustodyExpense()">🔨 مصروف عهدة</button><button class="btn btn-primary" onclick="Crud.addOwnerDeposit()">👤 توريد صاحب المكتب</button><button class="btn btn-primary" onclick="Crud.addOfficeIncome()">📈 إيراد مكتبي</button><button class="btn btn-primary" onclick="Crud.addOwnerWithdrawal()">🏃 سحب صاحب المكتب</button><button class="btn btn-primary" onclick="Crud.addOfficeCustody()">💼 عهد نقدية</button><button class="btn btn-secondary" onclick="App.exportOfficeExcel()">📥 تحميل Excel</button></div></div><div class="kpi-grid" id="office-kpis"><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div></div><div class="card" style="margin-top:16px"><h3>تفاصيل المعاملات</h3><div id="office-tbl"><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div></div></div><div class="card" style="margin-top:16px"><h3>💼 العهد النقدية</h3><div id="office-custody-tbl"><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div></div></div>`;

...
const App = {
  ...
  pageContent(screen) {
    if (screen === 'dashboard') return `<div class="page-header"><h1>📊 لوحة التحكم</h1></div><div class="kpi-grid" id="kpis"><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div><div class="kpi-card skeleton skeleton-kpi"></div></div><div class="content-grid"><div class="card"><h3>📊 إيرادات vs مصروفات</h3><div id="income-expense-total-chart"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div></div><div class="content-grid" style="margin-top:16px"><div class="card"><h3>📈 الإيرادات والمصروفات الشهرية</h3><div id="dash-monthly-chart"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div><div class="card"><h3>🏢 توزيع مصروفات المكتب</h3><div id="dash-office-sectors"><div class="skeleton skeleton-text"></div><div class="skeleton skeleton-text short"></div></div></div></div><div class="content-grid" style="margin-top:16px"><div class="card"><h3>🏆 أرصدة الموردين المستحقة</h3><div id="dash-vendors"><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div></div></div><div class="card"><h3>👥 أرصدة العملاء النشطين</h3><div id="dash-clients"><div class="skeleton skeleton-table-row"></div><div class="skeleton skeleton-table-row"></div></div></div></div><div class="content-grid" style="margin-top:16px"><div class="card"><h3>🚨 تنبيهات الموردين</h3><div id="dash-vendor-alerts"><div class="skeleton skeleton-table-row"></div></div></div><div class="card"><h3>💼 عهد نقدية غير مقفلة</h3><div id="dash-custody-alerts"><div class="skeleton skeleton-table-row"></div></div></div></div>`;
